...
const CreateNewFauna = props => {
        ...
        const prepareTransaction = async() => {
            ...
            try{
                setLoading(true)
                const transaction = await generateNewTransaction('fauna', specie, image, local, specieHistory, arweaveAccount.wallet)
        ...
        return(
            <Grid centered>
                ...
                <ModalConfirmTransaction 
                    ...
                    specie={specie} dateRegistry={dateRegistry}
               ...
               <ModalListHistory 
                ...
                <Form style={{margin:10, backgroundColor:'#8bc17b', borderRadius:10, padding: 25}}>
                    <div style={{backgroundColor:'#3e713a', borderRadius: 10, margin: 10}}>
                        <p align="center" style={{fontSize:16, fontWeight:700, padding: 10, color:'#c5ddc0'}}>Create New Fauna Registry</p>
                    </div>
                    <Form.Field>
                        <label>Specie</label>
...
const ModalConfirmTransaction = props => (
    <Modal open={props.open}>
      <Modal.Header style={{backgroundColor: '#3e713a', color:'#c5ddc0'}}>Confirm New Fauna Registry</Modal.Header>
